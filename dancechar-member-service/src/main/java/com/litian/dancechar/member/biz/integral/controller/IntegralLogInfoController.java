...
public class IntegralLogInfoController {
    ...
    public RespResult<IntegralLogInfoRespDTO> findById(@RequestBody IntegralLogInfoReqDTO req) {
        return RespResult.success(DCBeanUtil.copyNotNull(new IntegralLogInfoRespDTO(), integralInfoService.findById(req.getId())));
    }
    ...
    public RespResult<IntegralLogInfoRespDTO> findByBusinessId(@RequestBody IntegralLogInfoReqDTO req) {
        ...
        return RespResult.success(DCBeanUtil.copyNotNull(new IntegralLogInfoRespDTO(), integralInfoService
                .findByCondition(req)));
    }
